...
<main class="container container-main margin-container">
	<nav aria-label="breadcrumb">
	  <ol class="breadcrumb-holder">
	    ...
	    <li class="breadcrumb-name active" aria-current="page">Importations</li>
	  </ol>
	</nav>
	<section class="content-holder bg-white">
		<h5 class="font-orange label-title">VAT RELIEF: IMPORTATIONS</h5>
		<hr>
		<a href="/relief/download/importations" class="btn btn-success">DOWNLOAD EXCEL FORMAT</a>
		<br><br>
		<form method="POST" action="/relief/importations/{{$company->id}}" class="needs-validation" enctype="multipart/form-data">
		  	@csrf	
		  	@if (session('warning'))
			...
			<div class="form-row">
				<div class="form-group col-md-6">
					...
					<input type="date" class="form-control {{ $errors->has('date') ? 'is-invalid' : ''}}" id="inputDate" data-date-format="DD MM YYYY"  name="date" value="{{ old('date') }}">
				</div>
				<div class="form-group col-md-6">
			...
			<div class="form-row">
				...
				<input type="hidden" name="type" value="importations"/>
			</div>
			<hr>
		    <div class="form-group">
		    ...
		    <a href="/relief/{{ $company->id }}/histories/importations" class="btn btn-danger">Back</a>
		</form>
	</section>
</main>
@endsection